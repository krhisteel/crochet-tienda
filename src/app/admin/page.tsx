      ...
      <div className="mx-auto max-w-6xl px-4 py-10">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex gap-3">
            <button
              onClick={() => { localStorage.removeItem("admin-token"); window.location.reload(); }}
              className="rounded-full border border-beige bg-white text-charcoal/60 px-4 py-2 text-sm hover:bg-cream transition-colors"
            >
              Cerrar Sesión
            </button>
            <Link
