  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] px-4 text-center">
      <div className="relative mb-8">
        <svg className="w-24 h-24 text-blush/20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="absolute -top-1 -right-1 w-8 h-8 rounded-full bg-blush flex items-center justify-center">
