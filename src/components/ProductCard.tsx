    ...
    <div className="group liquid-card rounded-3xl overflow-hidden">
        ...
        <div className="relative aspect-[4/5] overflow-hidden">
          {product.imageUrl ? (
            ...
            <div className="flex items-center justify-center h-full bg-gradient-to-br from-blush/5 via-beige to-amber/5">
              <span className="text-7xl opacity-20 group-hover:scale-125 group-hover:opacity-30 transition-all duration-700">
      ...
      <div className="p-5">
        <div className="flex items-center gap-2 mb-3">
          <span className="inline-flex items-center text-[11px] font-semibold text-amber bg-amber/8 rounded-full px-2.5 py-1">
